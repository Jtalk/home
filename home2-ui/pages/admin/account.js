...
export default function EditAccount() {
  ...
  let changePassword = async (data) => {
    ...
    try {
      ...
      errors
        .validate(
          passwordConfirmed(data.password.new, data.password.confirmation),
...
export const EditAccountStateless = function ({
  onSubmit,
  updating,
  username,
  errors,
  ...
  return (
    <Grid centered>
      ...
      <Grid.Column width={11}>
        <Segment raised>
          <h2>Edit Account</h2>
          <Form onSubmit={onSubmit} success={updating === Updating.UPDATED} error={errors.hasErrors()}>
            <Divider />
            <Grid stackable>
              <Grid.Row>
